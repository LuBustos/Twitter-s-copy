...
//SubmitAvatar nos permite subir el avatar al server
func SubmitAvatar(w http.ResponseWriter, r *http.Request) {
	...
	var arch string = "uploads/avatars/" + IDUser + "." + extension
